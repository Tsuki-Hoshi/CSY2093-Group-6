...
SELECT 300001, 'Park Plaza London Westminster Bridge', 'Modern hotel on Londons South Bank, opposite Big Ben, offering stylish rooms, spa, pool, dining, and easy access to major attractions.', 'B', '03334006112', 2000, 
...
SELECT 300003, 'Plaza Timber', 'B', '07306036151', 2050, REF(a) FROM addresses WHERE a.street= '9 Junction Road', 'Ensuite room with free food and access to the Pool bar',
facility_varry_type(
...
INSERT INTO hotels (hotel_id, name, rating, contact_no, capacity, addresses, facilities, description)
SELECT 300004, 'Hotel Oak Bridge', 'C', '073890321171', 1, REF(a) FROM addresses WHERE a.street= '73 St. Michaels Road', 'Ensuite with a free mini fridge and access to the Bar',
facility_varry_type(
...
INSERT INTO hotels (hotel_id, name, rating, contact_no, capacity, addresses, facilities, description)
SELECT 300005, 'Premier Hotel', 'A', '073083647183', 1, REF(a) FROM addresses WHERE a.street='67 St. Michaels Road', 'Single room with shared bathroom with access to Joining rooms',
facility_varry_type(
